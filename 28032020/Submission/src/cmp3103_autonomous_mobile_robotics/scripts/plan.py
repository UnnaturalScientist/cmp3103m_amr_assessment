...
if __name__ == '__main__':
    #TODO There needs to be a mechanism to cancel the navgoals somewhere
    # It could be in this file, or perhaps even another
    # It would simply be a "while this is happening"...
    # ....until BLUE IS FOUND, then cancel all navgoals
    rospy.init_node('Plan')

    # !!! It could be as simple as giving reactive behaviours a ridiculously high priority
